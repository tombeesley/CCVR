...
anovaBF(formula = meanRT ~ TT*targ_depth + subj,
        whichRandom = "subj",
        data = data_RT_ANOVA)
...
data_ego_test <- 
  data_test %>%
  mutate(egocentric = case_when(condition == "proximal_repeated" & targ_depth == "Near targets"
                                ~ "Egocentric - Near",
                                condition == "proximal_repeated" & targ_depth == "Far targets"
                                ~ "Egocentric - Far",
                                condition == "distal_repeated" & targ_depth == "Near targets"
                                ~ "Egocentric - Far",
                                condition == "distal_repeated" & targ_depth == "Far targets"
                                ~ "Egocentric - Near")) %>% 
