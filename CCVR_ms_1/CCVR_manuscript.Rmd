...
While running Experiment 1, it was found that there were occasions on which some participants struggled to complete a trial, and the experiment could not progress until the target had been accurately detected. To alleviate this issue, we added a timeout to the trial procedure, terminating the trial after 10 seconds. Other minor adjustments were made to the procedure. These changes were made in an attempt to increase the amount of data retained for analysis. We did not anticipate that these changes would affect the variables of interest in the experiment (nor did they). We present these two procedures as Experiments 1a and 1b, but present the results together. 
