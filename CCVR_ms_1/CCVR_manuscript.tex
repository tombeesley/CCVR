...
\hypersetup{
  pdftitle={Examing the role of depth information in contextual cuing using a virtual reality visual search task},
...
The data, analysis scripts, experimental materials, and the manuscript code, are available at \href{https://github.com/tombeesley/CCVR}{github.com/tombeesley/CCVR}. The analyses reported in this manuscript are computationally reproducible using R.
...
The analyses we report are computationally reproducible using the analysis and manuscript files at \href{https://github.com/tombeesley/CCVR}{github.com/tombeesley/CCVR}.
