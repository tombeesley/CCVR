...
Participants were given 10 practice trials to familiarize themselves with the task. This provided participants with a guide as to how they should direct their head position towards the centre of the target object, prior to responding with the spacebar. Participants were told to search for a ``pill-shaped target'' and to press the spacebar once the central blue circle region was over the target object \footnote{It should be noted that the use of a single response key for target detection deviates from the majority of the work on contextual cuing that used two response keys (e.g., left/right); it is possible that this has some consequence for the operation of response related processes that contribute to the contextual cuing effect, Schankin and SchubÃÂ¶ (2009) and Schankin et al. (2011)}. This provided a guide to how the program would register accurate target detection. The blue circle was used for training only and not presented in the main phase of the experiment. After a successful detection of the target, the white fixation circle appeared. The program detected the gaze on this fixation circle before initiating the next trial.
...
Schankin, A., Hagemann, D., \& SchubÃÂ¶, A. (2011). Is contextual cueing more than the guidance of visualâ€``spatial attention? \emph{Biological Psychology}, \emph{87}(1), 58--65. \url{https://doi.org/10.1016/j.biopsycho.2011.02.003}

\leavevmode\vadjust pre{\hypertarget{ref-schankin2009b}{}}%
Schankin, A., \& SchubÃÂ¶, A. (2009). Cognitive processes facilitated by contextual cueing: {Evidence} from event-related brain potentials. \emph{Psychophysiology}, \emph{46}(3), 668--679. \url{https://doi.org/10.1111/j.1469-8986.2009.00807.x}
