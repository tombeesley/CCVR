...
Participants were given 10 practice trials to familiarize themselves with the task. This provided participants with a guide as to how they should direct their head position towards the centre of the target object, prior to responding with the spacebar. Participants were told to search for a ``pill-shaped target'' and to press the spacebar once the central blue circle region was over the target object \footnote{It should be noted that the use of a single response key for target detection deviates from the majority of the work on contextual cuing that used two response keys (e.g., left/right); it is possible that this has some consequence for the operation of response related processes that contribute to the contextual cuing effect, (Schankin et al., 2011; Schankin \& Schubö, 2009)}. This provided a guide to how the program would register accurate target detection. The blue circle was used for training only and not presented in the main phase of the experiment. After a successful detection of the target, the white fixation circle appeared. The program detected the gaze on this fixation circle before initiating the next trial.
...
\caption{RT data for Experiment 1A and 1B. Circles reflect trials with near targets (T) and squares those with far targets. White symbols are used for trials with distractors that are entirely randomised, while black symbols are those trials with repeating distractors. Error bars reflect standard error of the mean (hereafter SEM).}\label{fig:Exp1-RT-figure}
\end{figure}
...
\caption{RT data from the ``test blocks'' of Experiment 2. Each test compares the reaction times in blocks containing random configurations to reaction times in adjacent blocks that contained repeated configurations. Error bars reflect SEM.}\label{fig:Exp2-test-figure}
\end{figure}
...
An additional Bayesian ANOVA (priors were set at the default ``medium'' width) was run with factors of \emph{configuration type}, \emph{target-depth}, and \emph{test} to explore the three-way interaction that was significant in the ANOVA reported earlier. This revealed a Bayes Factor for the interaction that did not amount to supporting evidence, BF = 1.1.
...
\caption{RTs across the tests in Experiment 2, as a function of egocentricity of the repeated configurations (near to the observer or far from the observer). Error bars reflect SEM.}\label{fig:Exp2-ego-figure}
\end{figure}
...
\leavevmode\vadjust pre{\hypertarget{ref-dienes2014}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-kawahara2003}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-kroell2019}{}}%
Kroell, L. M., Schlagbauer, B., Zinchenko, A., Müller, H. J., \& Geyer, T. (2019). Behavioural evidence for a single memory system in contextual cueing. \emph{Visual Cognition}, \emph{27}(5-8), 551--562. \url{https://doi.org/10.1080/13506285.2019.1648347}

\leavevmode\vadjust pre{\hypertarget{ref-marek2020}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-mcsorley2001}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-nakayama1986}{}}%
Nakayama, K., \& Silverman, G. H. (1986--26 C.E.). Serial and parallel processing of visual feature conjunctions. \emph{Nature}, \emph{320}(6059), 264--265. \url{https://doi.org/10.1038/320264a0}
...
\leavevmode\vadjust pre{\hypertarget{ref-schankin2011}{}}%
Schankin, A., Hagemann, D., \& Schubö, A. (2011). Is contextual cueing more than the guidance of visual--spatial attention? \emph{Biological Psychology}, \emph{87}(1), 58--65. \url{https://doi.org/10.1016/j.biopsycho.2011.02.003}

\leavevmode\vadjust pre{\hypertarget{ref-schankin2009a}{}}%
Schankin, A., \& Schubö, A. (2009). Cognitive processes facilitated by contextual cueing: {Evidence} from event-related brain potentials. \emph{Psychophysiology}, \emph{46}(3), 668--679. \url{https://doi.org/10.1111/j.1469-8986.2009.00807.x}
...
\leavevmode\vadjust pre{\hypertarget{ref-vadillo2021}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-zang2017}{}}%
